...
public class _OVAL extends nodoModelo{
    
   
    /**
     * constructor de _OVAL
    ...
    public _OVAL(itemAtributo atrib, elementoGlobal simbolo) {
        super(atrib, simbolo);
    }
     ...
     *<br> Oval (posición en X, posición en Y, color, Ancho, Alto)
    ...
    public itemRetorno ejecutar(elementoEntorno entorno) { 
        ...
        validandoDebug();
         ...
         if(lstValores.size() == 5 ){
             ...
             simbolo.ctrlLienzo.pintarOvalo(pPosX, pPosY, pColor, pAncho, pAlto);
             return retorno;
         }else{
             //error
