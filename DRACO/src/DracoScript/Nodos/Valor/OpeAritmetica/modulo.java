...
public class modulo {
     ...
     */
    /**
     * Metodo que retorna el valor al operar Módulo
     *
    ...
    public itemValor getValor(itemValor val1, itemValor val2, elementoEntorno entorno) { 
       ...
       itemValor retorno=new itemValor(simbolo);
        ...
        if(val1.isTypeNulo()||val2.isTypeNulo()){
            simbolo.tablaErrores.insertErrorSemantic(atrib, "No se puede operar módulo(%) con un valor de tipo nulo");
            return retorno;
        }
        ...
        */
         ...
         */
            ...
            if(dVal2==0.0|| dVal2==0){
                simbolo.tablaErrores.insertErrorSemantic(atrib, "(Operación Módulo %)No se puede dividir entre cero");
                return retorno; 
            }
