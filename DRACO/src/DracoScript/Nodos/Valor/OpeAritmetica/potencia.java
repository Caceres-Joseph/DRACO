...
public class potencia {
    ...
    itemAtributo atrib;
    String signo;
    public potencia(elementoGlobal simbolo, itemAtributo atrib, String signo){
    ...
    public itemValor getValor(itemValor val1, itemValor val2, elementoEntorno entorno) { 
       ...
       itemValor retorno=new itemValor(simbolo);
        ...
        if(val1.isTypeNulo()||val2.isTypeNulo()){
            simbolo.tablaErrores.insertErrorSemantic(atrib, "No se puede potencia con un valor de tipo nulo");
            return retorno;
        }
        ...
        */
         ...
         */
            ...
            Double dVal1 = (double) ob1;
            if ((dVal2 == 0.0 || dVal2 == 0) && (dVal1 == 0.0 || dVal1 == 0)) {
                simbolo.tablaErrores.insertErrorSemantic(atrib, "No se puede elevar a 0 una potencia de base 0, Resultado: Indeterminado");
                return retorno;
            }
             
            double resul = Math.pow((double) ob1, (double) ob2);
        ...
        */
         ...
         */
            ...
            Double dVal1 = val1.getNumero();
            if ((dVal2 == 0.0 || dVal2 == 0) && (dVal1 == 0.0 || dVal1 == 0)) {
                simbolo.tablaErrores.insertErrorSemantic(atrib, "No se puede elevar a 0 una potencia de base 0, Resultado: Indeterminado");
                return retorno;
            }
             
            double resul = Math.pow(dVal1, dVal2);
            retorno.setValor(resul);
            return retorno;
        }
